...
import BrowserHeader from '@/views/ai/components/BrowserHeader.vue'
import FilterCard from '@/views/ai/components/FilterCard.vue'
import FilterChips from '@/views/ai/components/FilterChips.vue'
import KeywordBar from '@/views/ai/components/KeywordBar.vue'
import EmptyState from '@/views/ai/components/EmptyState.vue'
import Pager from '@/views/ai/components/Pager.vue'
...
import type { ListMode } from '@/views/ai/components/ModeSwitch.vue'
