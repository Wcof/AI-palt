...
import AIList from '@/views/ai/list.vue'
import AISearch from '@/views/ai/search.vue'
import AIDetail from '@/views/ai/detail.vue'
import BannerManager from '@/views/ai/settings/bannerManager.vue'
...
const router = createRouter({
  ...
  routes: [
    { path: '/', redirect: '/ai-app' },
    {
      ...
      component: AppShell,
      children: [
        { path: 'abilities', component: AIList },
        { path: 'search', component: AISearch },
        { path: 'ability/:id', component: AIDetail },
        { path: 'banner', component: BannerManager },
        ...
        { path: 'developers', redirect: '/workbench/apps' },
        {
          path: 'workbench',
