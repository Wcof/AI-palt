---
page_id: page-pathMatch
route: /:pathMatch(.*)*
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-pathMatch-core"]
change_ids: ["chg-pathMatch-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-pathMatch-init | page-pathMatch | feat-pathMatch-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
