...
page_id: page-system
route: system
code_paths: ["../views/newAI/agent.vue"]
feature_ids: ["feat-system-core"]
change_ids: ["chg-system-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-system-init | page-system | feat-system-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
