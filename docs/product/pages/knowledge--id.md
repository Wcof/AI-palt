---
page_id: page-knowledge--id
route: knowledge/:id
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-knowledge--id-core"]
change_ids: ["chg-knowledge--id-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-knowledge--id-init | page-knowledge--id | feat-knowledge--id-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
