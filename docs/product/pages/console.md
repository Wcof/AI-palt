---
page_id: page-console
route: console
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-console-core"]
change_ids: ["chg-console-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-console-init | page-console | feat-console-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
