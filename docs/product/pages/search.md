...
page_id: page-search
route: search
code_paths: ["../views/dashboard/ai/index.vue"]
feature_ids: ["feat-search-core"]
change_ids: ["chg-search-init"]
...
| 页面路由 | search |
| 所属模块 | [TODO: 所属模块] |
| 页面文件 | ../views/dashboard/ai/index.vue |
| 使用角色 | [TODO: 使用角色] |
| 页面定位 | [TODO: 页面定位] |
| 上游入口 | [TODO: 上游入口] |
| 下游页面 | [TODO: 下游页面] |
...
|---|---|---|---|---|---|---|---|---|
| chg-search-init | page-search | feat-search-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
