---
page_id: page-workbench-subscriptions
route: workbench/subscriptions
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-workbench-subscriptions-core"]
change_ids: ["chg-workbench-subscriptions-init"]
...
|---|---|
| 页面名称 | 文档支持 |
| 页面路由 | workbench/subscriptions |
| 所属模块 | [TODO: 所属模块] |
| 页面文件 | ../views/ai/mcp/skillDetail.vue |
| 使用角色 | [TODO: 使用角色] |
| 页面定位 | [TODO: 页面定位] |
| 上游入口 | [TODO: 上游入口] |
| 下游页面 | [TODO: 下游页面] |
...
|---|---|---|---|---|---|---|---|---|
| chg-workbench-subscriptions-init | page-workbench-subscriptions | feat-workbench-subscriptions-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
