---
page_id: page-workbench-keys
route: workbench/keys
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-workbench-keys-core"]
change_ids: ["chg-workbench-keys-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-workbench-keys-init | page-workbench-keys | feat-workbench-keys-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
