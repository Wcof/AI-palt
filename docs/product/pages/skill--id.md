---
page_id: page-skill--id
route: skill/:id
code_paths: ["../views/ai/mcp/skillDetail.vue"]
feature_ids: ["feat-skill--id-core"]
change_ids: ["chg-skill--id-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-skill--id-init | page-skill--id | feat-skill--id-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
