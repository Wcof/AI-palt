...
page_id: page-ai-app
route: ai-app
code_paths: ["../views/newAI/apiKey.vue"]
feature_ids: ["feat-ai-app-core"]
change_ids: ["chg-ai-app-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-ai-app-init | page-ai-app | feat-ai-app-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
