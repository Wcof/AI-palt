...
page_id: page-agents
route: agents
code_paths: ["../views/newAI/mcp.vue"]
feature_ids: ["feat-agents-core"]
change_ids: ["chg-agents-init"]
...
|---|---|---|---|---|---|---|---|---|
| chg-agents-init | page-agents | feat-agents-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
