---
page_id: page-ability--id
route: ability/:id
code_paths: ["../views/newAI/knowledge.vue"]
feature_ids: ["feat-ability--id-core"]
change_ids: ["chg-ability--id-init"]
...
| 页面路由 | ability/:id |
| 所属模块 | [TODO: 所属模块] |
| 页面文件 | ../views/newAI/knowledge.vue |
| 使用角色 | [TODO: 使用角色] |
| 页面定位 | [TODO: 页面定位] |
| 上游入口 | [TODO: 上游入口] |
| 下游页面 | [TODO: 下游页面] |
...
|---|---|---|---|---|---|---|---|---|
| chg-ability--id-init | page-ability--id | feat-ability--id-core | [TODO: commit] | v0.1 | 2026-05-24 | 初始化页面 PRD | 是 | 初版 |
