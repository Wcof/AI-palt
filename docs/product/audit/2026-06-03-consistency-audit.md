...
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-a->feat-cocreation-list | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-b->feat-assistant-model | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-c->feat-cocreation-list | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-d->feat-quota-governance | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-d->feat-account-quota | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-e->feat-quota-governance | 修正 affected_feature_ids |
| P1 | 变更记录引用不存在功能 | `docs/product/changelog/newAI-system-change.md` | newAI-system-change-20260603-e->feat-account-quota | 修正 affected_feature_ids |
